...
const NewPostModal =({ setVisible }: IProps) => {
    ...
    return nextStep === 0 ? (
        ...
        <div className='  flex-col justify-center items-center text-center rounded-xl bg-white w-[500px] h-[500px]'>
            ...
            <div className='flex flex-col items-center justify-center '>
                ...
                {/* <button className='bg-blue-500 rounded-lg px-4 py-1  text-white'>Select from computer</button> */}
        ...
        nextStep === 1 ?
            (
                <div className='bg-white  rounded-xl '>
                    ...
                    <img className='rounded-b-xl w-[600px] h-[600px]' src={imagesUrl} alt="" />
                </div>
            ) :
            ...
            <div className='bg-white rounded-xl '>
                ...
                <div className='flex '>
                    <img className='rounded-bl-xl w-[600px] h-[600px]' src={imagesUrl} alt="" />
